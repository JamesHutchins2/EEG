...
def train_one_epoch(data_loader, optimizer, 
                    device, epoch, grad_scaler,
                    mask_ratio,logger, config=None, 
                    model=None, logg_steps = 20, 
                    lr=0.001, min_lr=0.0, 
                    num_epoch=500, warmup_epochs=40):
    """
    ...
    for step, batch in enumerate(data_loader):
        if step % accum_iter == 0:
            ...
            ut.adjust_learning_rate(optimizer, step / len(data_loader) + epoch,
