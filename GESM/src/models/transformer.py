...
class MaskedAutoencoder(nn.Module):
    ...
    def forward_encoder(self, x):
        ...
        #the mask is: 1 for masked positions, 0 for unmasked positions
        #ids_restore is used to restore the original order of the sequence after shuffling
    ...
    def forward(self, imgs, target_imgs):
        ...
        loss = self.forward_loss(pred, target_imgs) 
