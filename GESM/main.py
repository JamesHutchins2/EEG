...
configs_path = '/mnt/a/MainFolder/Neural Nirvana/encoder_transformer/model_copy/EEG/GESM/config.yaml'
...
def main():
    ...
    target_dataset = loader.load_target_data(batch_size=batch_size)
    ...
    for participant_group in participant_sub_groups:
        ...
        for ep in range(num_epochs):
            ...
            cor = train_one_epoch(dataloader_train, target_dataset,
                                  optimizer, device, ep, loss_scaler, 0.8, logger, 
